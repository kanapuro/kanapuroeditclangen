...
def json_load():
    ...
    for i, cat in enumerate(cat_data):
        try:
            ...
            # Migrate older status spellings to "former colonycat"
            old_former_clan = {"former clancat", "former_Clancat", "former_clancat", "former Clancat"}
            if cat["status"] in old_former_clan:
