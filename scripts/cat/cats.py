    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            # Fallback if default_pronouns doesn't exist or is empty
            self.pronouns = [{"subject": "they", "object": "them", "poss": "their", "inposs": "theirs", "self": "themself", "conju": 1}]
        if not self.pronouns:  # Double-check
            self.pronouns = [{"subject": "they", "object": "them", "poss": "their", "inposs": "theirs", "self": "themself", "conju": 1}]
        self.placement = None
...
# pylint: disable=f-string-without-interpolation
    ...
    def is_dateable(self,
        ...
        if not ignore_no_mates and (getattr(self, 'no_mates', False) or getattr(other_cat, 'no_mates', False)):
