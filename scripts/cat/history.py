...
class History:
    ...
    def add_mentor_skill_influence_strings(cat):
        ...
        skill_influence_text = {
                ...
                SkillPath.STAR: [ "connecting to spirits" ],
                SkillPath.DARK: [ "connecting to dark spirits" ],
                ...
                SkillPath.GARDENER: ["tending to the colony's garden"],
                SkillPath.UNKNOWN: ["connecting to wanderers"],
