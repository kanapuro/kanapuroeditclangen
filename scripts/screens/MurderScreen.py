...
class MurderScreen(Screens):
    ...
    def change_cat(self, new_mentor=None, accomplice=None, accompliced=None):
        ...
        death_chance = self.get_death_chance(self.cat_to_murder, accomplice=accomplice, accompliced=accompliced)

        print("\n" + "="*50)
        print(f"MURDER ATTEMPT DEBUG:")
        print(f"Method: {self.method}, Location: {self.location}, Time: {self.time}")
        print(f"Victim: {self.cat_to_murder.name} ({self.cat_to_murder.status})")
        if accomplice:
        ...
        print(f"  Final threshold: {max(5, chance + r2)}")
        print(f"  Random roll (r): {r}")
    ...
    def get_death_chance(self, cat_to_murder, accomplice, accompliced):
        ...
        if self.method == "attack":
            chance += 5
            print(f"  +Attack: {chance}")
        elif self.method == "poison":
            if you.status not in ["medicine cat", "medicine cat apprentice"]:
                chance += 1
                print(f"  +Poison (non-med): {chance}")
        elif self.method == "accident":
            chance += 8
            print(f"  +Accident: {chance}")
        elif self.method == "predator":
            chance += 12
            print(f"  +Predator: {chance}")
        ...
        if self.location == "camp":
            ...
            chance += 5
            print(f"  +Territory: {chance}")
        elif self.location == "border":
            chance += 10
            print(f"  +Border: {chance}")
        ...
        if self.time == "dawn":
            ...
            chance += 10
            print(f"  +Night: {chance}")

        if accomplice and accompliced:
            chance -= 2
            print(f"  -Accomplice: {chance}")

        if cat_to_murder.moons > 12:
            chance += 2
            print(f"  +Over 12 Moons: {chance}")
