...
class Cat:
    ...
    def init_faded(self, ID, status, prefix, suffix, moons, **kwargs):
        ...
        """
        self.ID = ID
        self.name = Name(status=status, prefix=prefix, suffix=suffix)
        self.parent1 = None
        self.parent2 = None
        self.adoptive_parents = []
        self.mate = []
        ...
        if self.status == 'leader':
            if game.clan.leader_lives > 0:
                ...
                if game.clan.instructor.df is False:
                    text = (
                        "They've lost their last life and have travelled to the afterlife."
                    )
                else:
                    text = "They've lost their last life and have travelled to a dark afterlife."
        else:
            self.dead = True
            game.just_died.append(self.ID)
        ...
        for cat in Cat.all_cats.values():
            ...
            # it can fail to to minor grief. If they have a family relation, bypass the roll.
                ...
                minor_grief_messages = (
                            ...
                            "Prays that r_c is safe in the afterlife",
                ...
                if body: 
                    minor_grief_messages += (
                        ...
                        "Clung so desperately to r_c's body that they had to be dragged away",
                        "Hides a scrap of r_c's fur under their nest to cling to",
